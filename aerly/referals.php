...
?>
 ...
 <table width="800" border="0" align="center">
  ...
  ?>
    <td colspan="3"><font color="#0099FF" font face="Times New Roman, Times, serif"><h1>Referrals</h1>
    </font></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2"><font color="#999999" font face="Times New Roman, Times, serif"><h4> Your Upline:</h4></font> <p>
      <?php print $_SESSION['upline'];?>
    </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
