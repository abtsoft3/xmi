...
<form name="form-earnings" method="post" action="getWithDrawAls.php" id="frm-earning">
 <table width="800" border="0" align="center">
  <?php
	include('dashboard_nav.php');
 ?>
    <td colspan="3"><font color="#0099FF" font face="Times New Roman, Times, serif"><h1>WithDrawAls</h1></font></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    ...
    <td colspan="2"><font color="#999999" font face="Times New Roman, Times, serif"><h4> Total:</h4></font> <p>
      <img src="../Gambar/471px-Ethereum_logo_2014.svg.png" width="13" height="22" /> &nbsp;  
		<strong><?php print $execute_wdw['total_withdraw'];?></strong>
    </td>
  ...
  <tr>
    ...
    <td><font color="#999999" font face="Times New Roman, Times, serif">
	  ...
	  <input readonly='true' type="text" name="date-from" id="date_from"
		value="<?php print date('Y-m-d');?>" required/>
	  </td>
	  <td>&nbsp;</td>
    <td><font color="#999999" font face="Times New Roman, Times, serif">
			...
			success:function(getdata)
			{
				...
				if(getdata.length > 0)
				{
					$.each(getdata,function(i,item){
						strhtml +='<tr>';
						strhtml +='<td>'+getdata[i].date_time_acc_wdw+'</td>';
						strhtml +='<td>'+getdata[i].amount_withdraw+'</td>';
						strhtml +='</tr>';
					});
				}
				else
				{
					strhtml +='<tr>';
					strhtml +='<td colspan="2" style="text-align: center;">Empty</td>';
					strhtml +='</tr>';
				}
