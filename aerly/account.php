...
?>
 ...
 ?>
  <td colspan="3"><h1>Dashboard</h1></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    ...
    <td colspan="2"><font color="#999999" font face="Times New Roman, Times, serif"><h4> Account balance:</h4></font> <p/>
	  ...
	  &nbsp; <strong><?php print $results_amount['Total_Spend']+$results_amount_earnings['total_earning'];?></strong>
    </td>
    <td colspan="2"><font color="#999999" font face="Times New Roman, Times, serif">
	<h4> Username:</h4></font><?php echo $_SESSION['username'] ?>
      </td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2"><font color="#999999" font="font" face="Times New Roman, Times, serif">
      <h4>Active Deposit:</h4>
    </font>
      <p> <img src="../Gambar/471px-Ethereum_logo_2014.svg.png" alt="" width="13" height="22" /> 
	  &nbsp; <strong><?php print $results_amount['Total_Spend'];?></strong> </p>
	  </td>
	   <td><font color="#999999" font face="Times New Roman, Times, serif">
	<h4> Your Upline:</h4></font><?php print $_SESSION['upline'];?>
      </td>
  ...
  <tr>
    ...
    <td  colspan="2"><font color="#999999" font="font" face="Times New Roman, Times, serif">
      ...
      <p> <img src="../Gambar/471px-Ethereum_logo_2014.svg.png" alt="" width="13" height="22" /> 
		&nbsp; <strong><?php print $results_amount_earnings['total_earning'];?></strong> </p>
	  </td>
    <td ><font color="#999999" font face="Times New Roman, Times, serif">
	<h4> Your Referral Link:</h4></font><a href="#">
		<small>
