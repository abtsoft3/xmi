...
$query_wdw = mysqli_query($db_handle->connectDB(),"select ifnull(amount_withdraw,0.0) 
...
?>
 ...
 ?>
    <td colspan="3"><font color="#0099FF" font face="Times New Roman, Times, serif"><h1> WITH DRAW</h1></font></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2"><font color="#999999" face="Times New Roman, Times, serif" font="font"><h4>Pay Out:</h4></font></h4>

      <p> <img src="../Gambar/471px-Ethereum_logo_2014.svg.png" alt="" width="13" height="22" /> 
	  &nbsp; <?php print $results_amount_earnings['total_earning']+$results_amount_earnings_referal['total_earning'];?> </p></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td colspan="2"><font color="#999999" font="font" face="Times New Roman, Times, serif">
      ...
      <p> <img src="../Gambar/471px-Ethereum_logo_2014.svg.png" alt="" width="13" height="22" /> &nbsp; 
	  <?php print $execute_wdw['amount_withdraw'];?></p></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <p/>
